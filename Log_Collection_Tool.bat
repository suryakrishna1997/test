...
echo.
echo ==========================================
echo   Welcome to Log Collector Tool
echo ==========================================
echo.

set /p D=Please provide a folder name to capture logs: 
if "%D%"=="" (
    echo.
...
echo.
mkdir "%D%" >nul 2>&1
for %%F in (Bugreport Logcat HS_Logs Maker_Logs MCU) do mkdir "%D%\%%F" >nul 2>&1
...
echo ==========================================
echo.
echo Logs are stored in: %D% folder
echo.
